...
export default function CustomCTA() {
  const t = useTranslations('CustomProject.cta');
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div
          className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] opacity-15"
          style={{ background: 'radial-gradient(ellipse, #F97316 0%, transparent 60%)' }}
        />
      </div>

      <div className="relative z-10 px-4 md:px-6 lg:px-24 max-w-4xl mx-auto text-center">
        <motion.h2
        ...
        >
          <a
            ...
            className="px-8 py-4 rounded-2xl text-white font-semibold text-lg transition-all duration-300 hover:scale-105 flex items-center gap-3"
            style={{
          ...
          <a
            href="mailto:hello@muhit.agency"
